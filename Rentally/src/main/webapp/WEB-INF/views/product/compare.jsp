                           ...
                           <div class="card card-product">
                              <div class="card-body">
                                 <div class="text-center position-relative">
                                 	<img src="https://d14b80fsv1tvpk.cloudfront.net/${compare.category_seq}/${compare.product_img}?w=200&h=200&f=webp&q=80"  width="200" height="200" alt="${compare.product_name}" class="mb-3 img-fluid" />
                                 </div>

...
<div class="border-bottom">
    ...
    <a class="nav-link" href="/dashboard/index.html?product_seq=1">TV</a>
</li>

						<li class="nav-item w-100 w-lg-auto"><a class="nav-link"
							href="/dashboard/index.html?product_seq=2">냉장고</a></li>
					<li class="nav-item w-100 w-lg-auto"><a class="nav-link"
							href="/dashboard/index.html?product_seq=3">건조기</a></li>
					<li class="nav-item w-100 w-lg-auto"><a class="nav-link"
							href="/dashboard/index.html?product_seq=4">세탁기</a></li>
								<li class="nav-item w-100 w-lg-auto"><a class="nav-link"
							href="/dashboard/index.html?product_seq=5">공기청정기</a></li>
						<li class="nav-item w-100 w-lg-auto"><a class="nav-link"
							href="/dashboard/index.html?product_seq=6">청소기</a></li>
								<li class="nav-item w-100 w-lg-auto"><a class="nav-link"
							href="/dashboard/index.html?product_seq=7">전자레인지</a></li>
								<li class="nav-item w-100 w-lg-auto"><a class="nav-link"
							href="/dashboard/index.html?product_seq=8">에어컨</a></li>
						<li class="nav-item w-100 w-lg-auto"><a class="nav-link"
							href="/dashboard/index.html?product_seq=9">스타일러</a></li>
					</ul>
				</div>
